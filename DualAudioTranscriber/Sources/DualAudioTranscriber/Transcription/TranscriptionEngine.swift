...
private let log = Logger(subsystem: "com.eugenerat.DualAudioTranscriber", category: "TranscriptionEngine")
...
final class TranscriptionEngine {
    ...
    var error: String?
    var micDeviceName: String = "None"
    var systemAudioInfo: String = "None"
