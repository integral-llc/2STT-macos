...
private let log = Logger(subsystem: "com.eugenerat.DualAudioTranscriber", category: "MicCapture")

@Observable
final class MicCaptureManager: AudioCapturing, @unchecked Sendable {
